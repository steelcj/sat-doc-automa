...
sat:changelog:
  - version: "0.1.1"
    ...
    notes: >
      Added a new section, The three spheres, with a Mermaid hub
      diagram and explanation of the sphere model, placed before any
      discussion of the spheres against other metrics. Restructured
      the causal chain to place access — accessibility, languages,
      and modalities of communication — at its head as the
      precondition for everything downstream, with a Mermaid chain
      diagram. Added the asymmetry paragraph tying access failures
      (capability asymmetry) and communication failures (information
      asymmetry) to the measuring-dependence principles as instances
      of one pattern.
  - version: "0.1.0"
    date: "2026-07-30"
    author: "Christopher Steel, Claude (Anthropic)"
...
# universal-cake-wellbeing-evaluation-metrics-v0.1.1
...
Before the spheres can be discussed in relation to any metric, the model itself needs stating. Wellbeing, in this framework, arises across three spheres — domains of a person's life that together carry the requirements of wellbeing.

- **Body**, the physical foundations: sleep, movement, nourishment, rest, comfort, energy.
- **Mind**, the psychological foundations: emotion, attention, meaning, competence.
- **Others**, the relational foundations: connection, belonging, contribution, trust.

At the centre of the diagram is not a fourth domain and not a region of overlap. The centre is **the person**, and what the person carries from the centre into any sphere is **presence** — an ability, not a place.
...
This is a hub, deliberately not a Venn diagram, and the distinction is load-bearing. A Venn reading would place presence where all three circles intersect, which would make presence *require* others — and that contradicts lived experience, because solitary presence is real and common: awareness of the breath, absorption in a walk, flow in craft work. The opposite reading, presence as mind-and-body only, fails in the other direction, because relational presence is also real and distinct — deep listening, attunement, actually-being-with. A parent fully present with a child is not doing a mind-body activity that happens to have a person nearby; the presence is in the relating.

The hub resolves this. Each sphere connects to the centre independently, so presence can be brought to any sphere without requiring the other two. Any sphere can be inhabited presently or absently: the body can be moved with awareness or dissociation, the mind observed or ruminated in, others attended to or scrolled past. Presence is the mode in which a sphere is inhabited, and the person is where that mode lives.

## Conceptual architecture

The framework rests on one causal chain, and the chain begins before presence. **Access — accessibility, languages, and modalities of communication — is a requirement for everything else.** A person cannot bring presence to a practice they cannot enter, cannot exercise agency within claims they cannot understand, and cannot receive outcomes from a practice that excludes their body, their language, or their way of communicating. Access is not one pillar among peers; it is the precondition of the chain.

> **Access (accessibility, languages, and modalities of communication) → admits the person to → Presence (ability) → enables → Agency (exercised choice) → directed toward → the three spheres (Body, Mind, Others) → producing → wellbeing.**

```mermaid
flowchart LR
    A["Access<br/>accessibility, languages,<br/>modalities of communication"]
    PR["Presence<br/>an ability"]
    AG["Agency<br/>exercised choice"]
    S["The three spheres<br/>Body, Mind, Others"]
    W["Wellbeing"]
    A -->|admits the person to| PR
    PR -->|enables| AG
    AG -->|directed toward| S
    S -->|producing| W
```

Because the chain is sequential, a failure at its head is not a partial deduction. A person who cannot access the practice cannot engage presence through it, cannot exercise agency within it, and receives nothing in the spheres. Access failure zeroes out everything downstream, which is the structural reason access criteria gate rather than score. Access is evaluated in detail under Inclusive access and, for the truthfulness of communication, under Evidence and integrity; its position here at the head of the chain is what those pillars' gates enforce.

One pattern underlies both faces of access. Accessibility failures are asymmetries of capability; communication failures — inflated claims, concealed harms, undisclosed costs — are asymmetries of information. Both attack the same point: the person's ability to enter the chain and choose within it. They are instances of the same pattern the measuring-dependence principles below make measurable, which is why a beautifully clear sales page that lies rates Strong on comprehensibility and gates on integrity.

Presence is treated as an ability, not a fourth sphere and not a region where the spheres overlap, as established above. Abilities belong to the person; the spheres describe domains of the person's life. Presence is what the person brings to whichever sphere they are inhabiting. It is trainable, it atrophies under hostile conditions, it is deployable across domains, and it is measurable with validated instruments.

Presence is load-bearing for agency. A person cannot choose among options they have not noticed, and cannot notice without being there. Presence opens the gap between stimulus and response; agency acts in that gap. An absent person still behaves, but their behaviour runs on default, habit, or someone else's design.
...
|---------|--------|-------|
| 0.1.1 | Draft | Added The three spheres section with Mermaid hub diagram and explanation, placed before any discussion of the spheres against other metrics; restructured the causal chain to place access (accessibility, languages, modalities of communication) at its head as precondition, with Mermaid chain diagram; added asymmetry paragraph tying access and communication failures to the measuring-dependence principles |
